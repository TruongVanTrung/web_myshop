...
if (isset($_GET['submit'])) {
	$sotrang=$_GET['number'];
	header("location:shop2.php?per_page=$sotrang&page=1");
}
?>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
								...
								<div class="product-image-wrapper">
									...
									<div class="choose">
										<ul class="nav nav-pills nav-justified">
											...
											<li><a href="suahanghoa.php?id=<?php echo $row2['id']; ?>"><i class="fa fa-plus-square"></i>Sửa</a></li>
											<li><a href="xoasanpham.php?id=<?php echo $row2['id']; ?>"><i class="fa fa-plus-square"></i>Xóa</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<form action="shop2.php" method="GET">
