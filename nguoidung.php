					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_description">
								<h4><a href=""><?php echo $row['diachi']; ?></a></h4>
								<p></p>
							</td>
							<td class="cart_price">
							...
							<td class="cart_total">
								<p class="cart_total_price">
									...
									$conn=mysqli_connect("localhost","root","","myshop");
									$sqll="SELECT * FROM trangthai WHERE id=$idtrangthai";
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="">Xem chi tiết</i></a>
							</td>
						</tr>
						<?php  
						$stt++;
