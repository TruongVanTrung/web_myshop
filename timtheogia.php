				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						if($giaa == 1){  
							...
							$sql= "SELECT * FROM hanghoa WHERE gia<7000000";
								...
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											...
											<h2>Giá: <?php echo number_format($row['gia']); ?></h2>
											<p><?php echo $row['tenmathang']; ?></p>
											<?php echo'<a href="addcart.php?item='.$row['id'].'" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>'?>
										</div>
						...
						if($giaa==2) {  
							$con=mysqli_connect("localhost","root","","myshop");
							$sql= "SELECT * FROM hanghoa WHERE gia>=7000000 AND gia<=19000000";
							$query1=mysqli_query($con,$sql);
							while($row = mysqli_fetch_assoc($query1)) 
							{
						?>
						...
						if($giaa==3) {  
							$con=mysqli_connect("localhost","root","","myshop");
							$sql= "SELECT * FROM hanghoa WHERE gia>19000000 ";
							$query1=mysqli_query($con,$sql);
							while($row = mysqli_fetch_assoc($query1)) 
							{
						?>
