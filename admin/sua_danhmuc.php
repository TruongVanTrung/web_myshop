          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <form action="xlsua_danhmuc.php" method="POST">
                  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tfoot>
						...
						if(isset($_GET['id'])){
							$sqll = "SELECT * FROM loaihang WHERE id='$id'";
                      ...
                      <tr>
                        <td></td>
                        <td><input type="text" name="tendanhmuc" value="<?php echo $row1['tenloaihang'] ;?>" ></td>
                        <td>
                            <button  type="submit" name="submitt" class="btn btn-outline-primary"> Sửa</button>
                          </td>
