  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../BaiTapHTML/menu.html">
        ...
        <div class="sidebar-brand-text mx-3">TravelBooKing</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="../BaiTapHTML/dangnhap.html">Login</a>
            <a class="collapse-item" href="../BaiTapHTML/dangki.html">Register</a>
            <a class="collapse-item" href="table2.html">Profile</a>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form action="xlsua_user.php" method="GET" class="w-full max-w-lg mx-auto py-4">
                ...
                <?php
                  ...
                  if ($result->num_rows > 0) {
                      ...
                      $id_role= $row['idrole'];
                      include'connect.php';
                      $sql="SELECT * FROM role WHERE id=$id_role";
                      ...
                      <tbody>
                        <tr>
                        <td><?php echo $stt; ?></td>
                        <td><input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="name_user" value="<?php echo $row['username']; ?>"></td>
                        <td><input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="pass_user" value="<?php echo md5($row['password']); ?>"></td>
                        <td >
                          <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" name="role">
                            <option value="<?php echo $id_role ?>" ><?php echo $rolee; ?></option>
                            <?php 
                            include'connect.php';
                            $sql1="SELECT * FROM role WHERE NOT(role='$rolee')";
                            $query1= $conn->query($sql1);
                            
                            while ($row2 = $query1->fetch_assoc()){
                            ?>
                              <option value="<?php echo $row2['id'] ?>"><?php echo $row2['role']; ?></option>
                            <?php
                            }
                            ?>
                          </select>
                        ...
                        <td>
                          ...
                          <a href="<?php echo'xlsua_user.php?id='.$row['id'];?>"><button  type="submit" name="edit_btn" class="btn btn-outline-primary"> Sửa</button></a>
                        </td>
                        </tr>
                      </tbody>
                      <?php
