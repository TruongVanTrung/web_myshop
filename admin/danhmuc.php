                  ...
                  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td>
                            <button  type="submit" name="submit" class="btn-outline-info"> Thêm</button>
                          </td>
                      </tr>
                    </tfoot>
                  </table>
                  ...
                  if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { 
                      ...
                      <tbody>
                        ...
                        <td>
                          <a href="<?php echo'sua_danhmuc.php?id='.$row['id'];?>"><button type="submit"  name="edit" class="btn btn-outline-primary"> Sửa</button></a>
                        </td>
                        <td>
                          <a href="<?php echo'xoa_danhmuc.php?id='.$row['id'];?>"><button type="submit" name="delete" class="btn btn-danger"> Xóa</button></a>
                        </td>
                        </tr>
                      </tbody>
                      <?php
