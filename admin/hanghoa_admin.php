    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Danh sách hàng hóa</h1>
          <p class="mb-4"></p>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <form action="them_hanghoa.php" method="POST" enctype="multipart/form-data">
                  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <h3>Thêm hàng hóa</h3>
                    <thead>
                      <tr>
                        <th class="" style="width: -50px">Image</th>
                        <th class="">Tên mặt hàng</th>
                        <th class="">Loại hàng</th>
                      ...
                      <tr>
                        <?php
                          if ($result->num_rows > 0) {
                              ...
                              $idloaihang=$row1['idloaihang'];
                              $iddanhmuc=$row1['iddanhmuc'];
                              ?>
                              <tbody>
                                <tr>
                                <td>
                                ...
                                <td><input type="text" name="tenmathang" value=""></td>
                                ...
                                <td>
                                  <select name=loaihang>
                                    ...
                                    ?>
                                      <option value="<?php echo $row1['id']; ?>"><?php echo $row2['tenloaihang']; ?></option>
                                    <?php  
                                    }
                                    ?>
                                  </select>    
                                ...
                                <td>
                                  <select name="danhmuc">
                                    ...
                                    ?>
                                    <option value="<?php echo $row2['id']; ?>"><?php echo $row3['tendanhmuc']; ?></option>
                                    <?php  
                                    }
                                    ?>
                                  </select>
                                ...
                                <td><input type="number" name="dongia" value=""></td>
                                <td>
                                  <button type="submit"  name="submit" class="btn btn-outline-primary"> Thêm</button>
                                </td>
                                </tr>
                              </tbody>
                              <?php
              ...
              <div class="table-responsive" style="margin-top: 20px">  
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <thead >
                    <tr class="" style="">
                      <th class="" >Stt</th>
                      <th class="" style="width: 100px">Image</th>
                      <th class="">Tên mặt hàng</th>
                      <th class="">Loại hàng</th>
                      <th class="">Danh mục</th>
                      <th class="">Số lượng</th>
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) { 
                      ...
                      <tbody>
                        <tr>
                        <td ><?php echo $stt; ?></td>
                        <td style="height: 100px;width: 100px"><img style="height: 100%;width: 100%;object-fit: contain;" src="img/<?php echo $row['linkimage']; ?>" class="img-responsive "></td>
                        <td><?php echo $row['tenmathang']; ?></td>
                        <?php  
                        $conn = mysqli_connect("localhost","root","","myshop");
                        $sql="SELECT * FROM loaihang WHERE id=$idloaihang";
                        $query = mysqli_query($conn,$sql);
                        ...
                        <td>
                          <a href="<?php echo'sua_hanghoa.php?id='.$row['id'];?>"><button type="submit"  name="edit" class="btn btn-outline-primary"> Sửa</button></a>
                        </td>
                        <td>
                          <a href="<?php echo'xoa_hanghoa.php?id='.$row['id'];?>"><button type="submit" name="delete" class="btn btn-danger"> Xóa</button></a>
                        </td>
                        </tr>
                      </tbody>
                      <?php
