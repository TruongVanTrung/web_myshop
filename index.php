		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<h2 class="title text-center">Sản phẩm mới/Giảm giá</h2>
					<div class="features_items"  id="dssanpham"><!--features_items-->
						<?php
							$ok=1;
							...
							{
							$items = $_SESSION['cart'];
							echo '<p>Ban dang co <u> <a href="cart.php" style="color:blue">'.count($items).' mon hang trong
							gio hang</a></u></p>';
							}
						?>
							<?php 
